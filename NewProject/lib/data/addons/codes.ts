/**
 * CÓDIGOS DE BIOMARCADORES - ADDONS - MIGRADO AUTOMÁTICAMENTE
 * Códigos tipados para addons
 */
...
export const getProfileExclusions = (addOnId: string, profileId: string, gender: string = 'both'): string[] => {
  const exclusions = (PROFILE_EXCLUSIONS as any)[addOnId];
  if (!exclusions) {
